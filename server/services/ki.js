...
const WRITING_RULES = [
  ...
  'WICHTIG — keine erfundenen Tatsachen: Der Beschluss darf nur Tatsachen voraussetzen, die der Nutzer genannt oder bestätigt hat. Erfinde keine Paragrafen-Nummern des Gesellschaftsvertrags, keine Anteils-Stückelung, keine Besicherungsabreden (auch "unbesichert" ist eine Abrede — hat der Nutzer zur Besicherung nichts gesagt, lass sie schlicht weg), keine Begründungen (z.B. "wegen gestiegener Verantwortung") und keine eingeholten Vergleichsangebote. Fehlt eine für die Bestimmtheit nötige Tatsache, setze einen Platzhalter in eckigen Klammern (z.B. "[Nummer des Geschäftsanteils]") und weise in "reply" darauf hin.',
